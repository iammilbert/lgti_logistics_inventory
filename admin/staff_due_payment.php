              ...
              <div class="card-body">
                ...
                <table id="example1" class="table font-size-13">
                  ...
                  $query = mysqli_query($conn, $sql) or die(mysqli_error($conn));
                      ...
                      <a class='btn btn-sm btn-info' href='staff_due_payment_details.php?staffId={$row["id"]}; ?>'><i class='fa fa-eye'></i>Slips</a>";

                        elseif ($row["payRollStatus"]==1 AND $month1 != $month) {
                          ...
                          echo "
                             <a class='btn btn-sm btn-success' href='payRollForm.php?staffId={$row["id"]}'><i class='fa fa-edit'></i> Pay Roll</a>
                             <button class='btn btn-sm btn-primary' data-toggle='modal' type='button' data-target='#staff_pay_modal{$row['id']}'></button> 
