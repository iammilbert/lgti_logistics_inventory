...
?>
  ...
  <div class="site-wrap">
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
          ...
          <h5 class="text-success bold"><b><?php echo $row4["name"]; ?>.</b></h5>
        </a>
      ...
      <div class="container">
        <div class="row align-items-center justify-content-center text-center">
          ...
          <div class="col" data-aos="fade-up" data-aos-delay="400">
            ...
            <h1 class="font-weight-light mb-5 text-Sentencecase font-weight-bold" style="font-weight:bolder; font-family: Geometr415 Blk BT;"><b>LGTI LOGISTICS.</b> <br> Fastest <span class="text-success">Logistics</span> Services</h1>
            <p><a href="#services" class="btn btn-success py-3 px-5 text-white">Get Started!</a></p>
      ...
      <div class="container">
        <div class="row justify-content-center mb-5">
          <div class="col-md-7 text-center border-success">
            <h2 class="font-weight-light text-success" id="services">Our Services</h2>
            ...
            <div class="unit-4 d-flex">
              <div class="unit-4-icon mr-4"><span class="text-success flaticon-frontal-truck"></span></div>
               <div>
                ...
                <p>Your delivery would make it across the country fom one city to the next by truck, until it reaches it's destination <span id="dots3">...</span></span><span id="more3" style="display: none;"> It is usually inexpensive and fast since it could be moved by LGTI Professional Drivers.</span></p>
          ...
          <div class="col-md-6 col-lg-4 mb-4 mb-lg-4">
            <div class="unit-4 d-flex">
              ...
              <div>
                ...
                <p>LGTI has got you covered with all sizes of vans and trucks suitable for moving small and large items, <span id="dots5">...</span><span id="more5" style="display: none;">  ranging from household and consumer goods, office equipment, home moving and office relocation.</span></p>
        ...
        <div class="slide-one-item home-slider owl-carousel">
          <div>
            <div class="testimonial">
              <figure class="mb-4">
                <img src="images/Passport.jpg" alt="LGTI testifiers" class="img-fluid mb-3">
                <p>Michael Gabriel</p>
              </figure>
              <blockquote>
          ...
          <div>
            <div class="testimonial">
              <figure class="mb-4">
                <img src="images/bar.jpeg" alt="LGTI testifiers" class="img-fluid mb-3">
                <p>Mr. Joseph</p>
              </figure>
              <blockquote>
          ...
          <div>
            <div class="testimonial">
              <figure class="mb-4">
                <img src="images/dan.jpeg" alt="LGTI testifiers" class="img-fluid mb-3">
                <p>Mr. Daniel John</p>
              </figure>
              <blockquote>
          ...
          <div>
            <div class="testimonial">
              <figure class="mb-4">
                <img src="images/car_1.png" alt="LGTI testifiers" class="img-fluid mb-3">
                <p>Bruce Rogers</p>
              </figure>
              <blockquote>
...
<style type="text/css">
  ...
  height: auto    !important;
          ...
          <div class="col-md-10" data-aos="fade-up" data-aos-delay="400">
            <video controls> 
              <source src="lgtivid.mp4" type="video/mp4">
