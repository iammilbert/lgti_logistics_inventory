      ...
      <div class="container">
        <div class="row">
          <div class="col-md-9">
            <div class="row">
              <div class="col">
                <h2 class="footer-heading mb-4 text-success">Quick Links</h2>
              ...
              <div class="col">
                <h2 class="footer-heading mb-4 text-success">Services</h2>
                <ul class="list-unstyled">
              ...
              <div class="col">
                        <h4 class="footer-heading text-success mb-4">Get In Touch</h4>
                        ...
                        <p><i class="icon-envelope mr-2 text-success"></i><a href="mailto:<?php echo $row4["email"]; ?>"><?php echo $row4["email"]; ?></a></p>

                         <p><i class="icon-envelope mr-2 text-success"></i><a href="mailto:<?php echo $row4["email2"]; ?>"><?php echo $row4["email2"]; ?></a></p>
      ...
      <form method="POST">
              <div class="input-group mb-3">
                ...
                <div class="input-group-append">
                  <input type="submit" name="subscribe" class="btn btn-success text-white" value="Send">
                </div>
              </div>
            </form>
          </div>
